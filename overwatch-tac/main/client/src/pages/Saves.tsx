...
// Reusable Modal Component with fade-in effect
    ...
    >
      <div
        style={{
          ...
          boxShadow: `0 0 30px ${confirmColor}33`,
          width: "400px",
          textAlign: "center",
        ...
        {loading ? (
          ...
          >
            <p style={{ color: "#777", fontSize: "18px", marginBottom: "20px" }}>
              {showAuthModal
                ? "Sign in or sign up to access saved strategies."
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            >
              <div style={{ color: "#555", fontSize: "11px", fontWeight: "bold", letterSpacing: "1px" }}>
                STRATEGY NAME
              </div>
              <div style={{ color: "#555", fontSize: "11px", fontWeight: "bold", letterSpacing: "1px" }}>
                MAP
            ...
            {saves.map((save) => (
              <div
                key={save.save_id}
                onClick={() => handleRowClick(save.save_id)}
                style={{
                  display: "grid",
                  gridTemplateColumns: gridLayout,
                  padding: "22px 25px",
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "#e60082";
              ...
              >
                <div style={{ fontWeight: "700", color: "#ffffff", fontSize: "18px", letterSpacing: "0.5px" }}>
                  {save.name}
                </div>
                <div style={{ color: "#e0e0e0", fontSize: "14px", fontWeight: "500" }}>
                  {save.Maps?.name || "Unknown"}
                </div>
