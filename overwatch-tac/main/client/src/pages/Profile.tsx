...
export default function Profile() {
          ...
          return (
            <div key={reply.reply_id} style={{ marginTop: 15 }}>
              <div style={{ background: '#111', padding: 16, borderRadius: 12, border: '1px solid #222' }}>
                ...
                <p style={{ fontSize: 14, color: '#ccc', margin: '10px 0' }}>{reply.text}</p>
                <div style={{ display: 'flex', gap: 8 }}>
                  <button onClick={() => handleReplyLike(reply.reply_id)} style={{ background: isReplyLiked ? "#3b82f633" : "#222", border: isReplyLiked ? "1px solid #3b82f6" : "1px solid #333", color: "white", padding: "4px 10px", borderRadius: 6, cursor: "pointer", fontSize: 12 }}>
                    👍 {reply.Reply_Likes?.length || 0}
                  </button>
                  <button onClick={() => handleReplyDislike(reply.reply_id)} style={{ background: isReplyDisliked ? "#ef444433" : "#222", border: isReplyDisliked ? "1px solid #ef4444" : "1px solid #333", color: "white", padding: "4px 10px", borderRadius: 6, cursor: "pointer", fontSize: 12 }}>
  ...
  return (
    <div style={{ maxWidth: 850, margin: "60px auto", padding: 20, color: "white", fontFamily: 'sans-serif' }}>
      {/* Header */}
        ...
        return (
          <div key={post.post_id} style={{ background: "#0a0a0a", padding: 24, borderRadius: 12, border: "1px solid #1a1a1a", marginBottom: 20 }}>
            ...
            <div style={{ margin: "18px 0" }}>
              <p style={{ fontSize: 14, color: '#ddd', margin: 0 }}>{post.text}</p>
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={() => handleLike(post.post_id)} style={{ background: isLiked ? "#3b82f633" : "#1a1a1a", border: "1px solid #333", color: "white", padding: "6px 14px", borderRadius: 8, cursor: "pointer" }}>👍 {post.Post_Likes?.length || 0}</button>
              ...
              <div style={{ marginTop: 20 }}>
                ...
                <div style={{ marginTop: 10 }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    }} style={{ background: "#3b82f6", color: "white", padding: "8px 18px", borderRadius: 8, border: 'none', cursor: 'pointer', fontWeight: 'bold' }}>Reply</button>
                  </div>
                </div>
              </div>
            )}
